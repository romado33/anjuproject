...
- Saves to `data/integration_settings.json` (or `INTEGRATION_SETTINGS_PATH`). The demo still uses **mock** adapter responses; production wiring would read this file from `Settings`.
